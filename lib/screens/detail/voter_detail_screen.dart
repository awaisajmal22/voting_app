              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      context.sizedBox(h: context.getSize.height * 0.01),
                      appRichText(
                          context: context,
                          title: 'First Name',
                          subtitle: model.fname ?? ''),
                      context.sizedBox(h: context.getSize.height * 0.01),
                      appRichText(
                          context: context,
                          title: 'Middle Name',
                          subtitle: model.mname ?? ''),
                      context.sizedBox(h: context.getSize.height * 0.01),
                      appRichText(
                          context: context,
                          title: 'Last Name',
                          subtitle: model.lname ?? ''),
                      context.sizedBox(h: context.getSize.height * 0.01),
                      appRichText(
                          context: context,
                          title: 'CNIC',
                ...
                Padding(
                  ...
                  child: customButton(
                      context: context,
                      onTap: () async {
                        bool isMatch = await provider.compareImages(
                            'https://cdn.pixabay.com/photo/2022/04/05/00/27/man-7112557_1280.jpg');
                        if (isMatch) {
                          Navigator.pushReplacementNamed(
                              context, AppRoutes.selectCandidate);
                        } else {
                          print("No matches");
                        }
                      },
